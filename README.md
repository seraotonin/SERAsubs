...
the same as generative AI that has harful effects on the environment. AS you can see, you are meant to download a 
folder called models, carrying training data, which is only about 3.5 GB. While I understand that this is a lot to 
download, this will effectively allow you to run SERAsubs completely offline. No data is sent to servesr that 
